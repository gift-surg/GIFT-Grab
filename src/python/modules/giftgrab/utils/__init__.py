...
def __extension(codec):
    ...
    in pygiftgrab
    """
    if codec == gg.Codec.File_XviD:
        return '.avi'
    elif codec == gg.Codec.File_HEVC:
        return '.mp4'
    elif codec == gg.Codec.File_VP9:
        return '.webm'
    else:
